...
(function (factory) {
    ...
    Mapael.prototype = {
        ...
        init: function () {
            ...
            // ad plugin class name on element
            ...
            // Hook that allows to ad custom processing on the map
        ...
        initElem: function (id, type, elem) {
            ...
            // If an HTML link exists for this element, ad cursor attributes
         ...
         *  opt.opt.newPlots new plots to ad to the map
         *  opt.newLinks new links to ad to the map
         *  opt.deletePlotKeys plots to delete from the map (array, or "all" to remove all plots)
         *  opt.deleteLinkKeys links to remove from the map (array, or "all" to remove all links)
         *  opt.setLegendElemsState the state of legend elements to be set : show (default) or hide
         *  opt.animDuration animation duration in ms (default = 0)
         *  opt.afterUpdate hook that allows to ad custom processing on the map
         */
            ...
            $.each(mapElems, function (y) {
                ...
                if (self.getLegendSlice(elemValue, legendOptions) === sliceOptions) {
                    if (hidden === '0') { // we want to hide this element
                        hiddenBy[legendIndex] = true; // ad legendIndex to the data object for later use
            ...
            var computeNextStep = function () {
                ...
                if (elapsed < durationWithMargin) {
                    ...
                    if (oldZoomAnimStartTime && self.zoomAnimCVBTarget && self.zoomAnimCVBTarget.w !== targetW) {
                        ...
                        // From the current value, we ad a delta with a ratio that will leads us to the target
                        x = cx + dx * ratio;
                        y = cy + dy * ratio;
                        w = cw + dw * ratio;
                        h = ch + dh * ratio;
