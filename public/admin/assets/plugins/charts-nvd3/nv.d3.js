...
nv.models.boxPlot = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            // ----- ad the SVG elements for each boxPlot -----
...
nv.models.discreteBar = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            //ad series index to each data point for reference
            data.forEach(function(series, i) {
...
nv.models.distroPlot = function() {
    ...
    function prepData(dat) {
        ...
        function calcStats(g, xGroup) {
            ...
            if (typeof d3.beeswarm !== 'undefined') {
                ...
                // ad group info for tooltip
                observations.map(function(e,i) {
                    e.key = xGroup;
                    e.object_constancy = g[i].object_constancy;
                    e.isOutlier = (e.datum < wl.iqr || e.datum > wu.iqr) // ad isOulier meta for proper class assignment
                    e.isOutlierStdDev = (e.datum < wl.stddev || e.datum > wu.stddev) // ad isOulier meta for proper class assignment
                ...
                v.forEach(function(e,i) {
                    observations.push({
                        ...
                        datum: e,
                        key: xGroup,
                        isOutlier: (e < wl.iqr || e > wu.iqr), // ad isOulier meta for proper class assignment
                        isOutlierStdDev: (e < wl.stddev || e > wu.stddev), // ad isOulier meta for proper class assignment
    ...
    function clampViolinKDE(kde, extent) {
        ...
        // ad the extreme data points back in
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            // ----- ad the SVG elements for each plot type -----
    ...
    chart._options = Object.create({}, {
        ...
        centralTendency:       {get: function(){return centralTendency;}, set: function(_){centralTendency=_;}}, // ad a mean or median line to the data - default: don't show, must be one of 'mean' or 'median'
...
nv.models.forceDirectedGraph = function() {
    ...
    var margin = {top: 2, right: 0, bottom: 2, left: 0}
        ...
        , alpha = 0.1
        , radius = 5
        // These functions allow to ad extra attributes to ndes and links
...
nv.models.multiBar = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            //ad series index and key to each data point for reference
            data.forEach(function(series, i) {
                series.values.forEach(function(point) {
                    point.series = i;
...
nv.models.sankeyChart = function() {
    ...
    function chart(selection) {
        selection.each(function(data) {
            ...
            // ad the rectangles for the nodes
            node.append('rect')
        ...
        selection.each(function(data) {
            ...
            function updateInteractiveLayer() {
                ...
                if (useVoronoi === true) {
                    ...
                    // ad event handlers to points instead voronoi paths
            ...
            // ad label a label to scatter chart
            if(showLabels)
            {
...
nv.models.scatterChart = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            // don't ad lines unless we have slope and intercept to use
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            interactiveLayer.dispatch.on('elementMousemove', function(e) {
                ...
                //If we are not in 'expand' mode, ad a 'Total' row to the tooltip.
...
nv.models.sunburst = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            if(showLabels){
                //remove labels first and ad them back
